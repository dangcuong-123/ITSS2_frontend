const Input = ({leftIcon, rightIcon, placeholder}) => {
  return (
    <div className="relative flex w-full flex-wrap items-stretch mb-3 border-1 border-[#2286C3]">
      ...
      <input type="text" placeholder={placeholder} className="px-3 py-3 placeholder-[#21212180] text-slate-600 relative bg-white text-sm border-2 border-[#2286C3] rounded-lg shadow outline-none focus:outline-none focus:ring w-full pl-12"/>
